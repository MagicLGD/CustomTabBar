...
- (void)viewDidLoad
{
    ...
    CGFloat orginHeight = self.view.frame.size.height- 40;
    if (iPhone5) {
        orginHeight = self.view.frame.size.height- 40 + addHeight;
    }
...
- (void)hideTabBar:(BOOL)hidden{
    ...
    if (hidden) {
        ...
        [_tabbar setFrame:CGRectMake(_tabbar.frame.origin.x, iPhone5?568-60:480-60, _tabbar.frame.size.width, _tabbar.frame.size.height)];
