...
-(void)layoutView
{
    self.tabbarView = [[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Toolbar_texbox.png"]] autorelease];
    ...
    [_button_center setImage:[UIImage imageNamed:@"bottom_m_nor.png"] forState:UIControlStateNormal];
    [_button_center setImage:[UIImage imageNamed:@"bottom_m_chick.png"] forState:UIControlStateSelected];
...
-(void)layoutBtn
{
    ...
    [_button_1 setImage:[UIImage imageNamed:@"bottom_1nor.png"] forState:UIControlStateNormal];
    [_button_1 setImage:[UIImage imageNamed:@"bottom_1chick.png"] forState:UIControlStateSelected];
    ...
    [_button_2 setImage:[UIImage imageNamed:@"bottom_2nor.png"] forState:UIControlStateNormal];
    [_button_2 setImage:[UIImage imageNamed:@"bottom_2chick.png"] forState:UIControlStateSelected];
    ...
    [_button_3 setImage:[UIImage imageNamed:@"bottom_3nor.png"] forState:UIControlStateNormal];
    [_button_3 setImage:[UIImage imageNamed:@"bottom_3chick.png"] forState:UIControlStateSelected];
